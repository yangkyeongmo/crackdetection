...
def create_image_lists(image_dir, testing_percentage, validation_percentage):
    ...
    이미지 디렉토리로부터 sub folder들을 분석하고, 그들을
    training, testing, validation sets으로 나눈다.
...
def main(_):
    ...
    with tf.Session(graph=graph) as sess:
        ...
        if FLAGS.draw_graph:
            plt.plot(x, y)
            plt.xlim(0, FLAGS.how_many_training_steps)
            plt.ylim(-5, 105)
            fig = plt.gcf()
            # plt.show()
            fig.savefig(os.path.join(os.path.dirname(output_graph_path), 'result_graph.png'))
...
if __name__ == '__main__':
    ...
    parser.add_argument(
            '--output_graph',
            type=str,
            default='/home/luar7olye/Dropbox/Projects/crack/data/output/train_result/output_graph.pb',
            help='Where to save the trained graph.'
    )
    parser.add_argument(
            '--output_labels',
            type=str,
            default='/home/luar7olye/Dropbox/Projects/crack/data/output/train_result/output_lables.txt',
            help='Where to save the trained graph\'s labels.'
    )
    parser.add_argument(
            "--output_parent_path",
            default='/home/luar7olye/Dropbox/Projects/crack/data/output/train_result/',
            type=str
    )
    parser.add_argument(
            "--output_path",
    ...
    parser.add_argument(
            '--summaries_dir',
            type=str,
            default='/home/luar7olye/Dropbox/Projects/crack/data/output/log/retrain_logs',
    ...
    parser.add_argument(
            '--model_dir',
            type=str,
            default='/home/luar7olye/Dropbox/Projects/crack/data/input/model',
            help="""\
    ...
    parser.add_argument(
            '--bottleneck_dir',
            type=str,
            default='/home/luar7olye/Dropbox/Projects/crack/data/output/bottleneck',
